        ...
        <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-gray-500/30 text-gray-500'>
            <div>
                ...
                <p className='max-w-[410px] mt-6'>Lorem ipsum dolor sit, amet consectetur adipisicing
                     elit. Pariatur eligendi cupiditate laborum tempora aliquam quam doloremque
                      nesciunt in ea voluptates dolorum corrupti, possimus laboriosam 
                      dolor dicta deserunt ipsum voluptas sed.</p>
            </div>
