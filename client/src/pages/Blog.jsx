...
const Blog = () => {
  ...
  return data?(
    <div className='relative'>
      <img 
      src={assets.gradientBackground} alt="" 
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        <div className='max-w-3xl mx-auto'>
            ...
            <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
              ...
              <textarea onChange={(e)=>setName(e.target.value)} value={content} placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48 ' required>
              </textarea>

              <button type='submit' className='bg-primary tex-white rounded p-2 px-8 hover:scale-102 transition-all cursor-pointer'>
                Submit
              </button>
            </form>
        </div>
